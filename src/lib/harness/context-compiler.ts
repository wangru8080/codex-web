 ...
 * adapter (ClaudeCode SDK, CodexWeb Native, Codex Runtime via
...
export interface CompiledContext {
  /** Runtime-agnostic CodexWeb opening (always empty in Phase 2;
 ...
 * mounted at least one CodexWeb built-in tool. 8 is the empirical
