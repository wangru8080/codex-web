 ...
 * product; instead, this module defines the narrow subset CodexWeb
...
export interface CodexClientInfo {
   ...
   * OpenAI Compliance Logs Platform. CodexWeb identifies as
...
// CodexWeb UI surfaces. Upstream only reports `usedPercent` + a reset
