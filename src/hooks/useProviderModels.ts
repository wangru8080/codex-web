...
export function useProviderModels(
  ...
  //   runtime (env filtered out under CodexWeb Runtime, etc.).
  //
  ...
  // Claude defaults would re-introduce the cross-wire (e.g. CodexWeb
  ...
  return {
    ...
    // empty CodexWeb install. The user-visible meaning we care about
