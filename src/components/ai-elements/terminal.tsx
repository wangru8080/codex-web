...
export const TerminalTitle = ({
  ...
  <div
    ...
    {...props}
  >
    <CodexWebIcon name="terminal" size="md" aria-hidden />
    {children ?? "Terminal"}
  </div>
);
...
export const TerminalCopyButton = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? (isCopied ? <Check size={14} /> : <CodexWebIcon name="copy" size="sm" aria-hidden />)}
    </Button>
  );
};
...
export const TerminalClearButton = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <CodexWebIcon name="delete" size="sm" aria-hidden />}
    </Button>
  );
};
