...
const mediaCategoryIcons: Record<AttachmentMediaCategory, CodexWebIconName> = {
  audio: "media_audio",
  document: "file",
  image: "image",
...
export const AttachmentPreview = ({
  ...
  const renderIcon = (name: CodexWebIconName) => (
    <CodexWebIcon name={name} size={iconSize} className="text-muted-foreground" />
  );
