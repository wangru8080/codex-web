...
export function CreateSkillDialog({
  ...
  const skillNamePreview = name.trim() || "<skill-name>";
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              >
                <CodexWebIcon name="folder_open" size="md" aria-hidden />
                {t('skills.project')}
              </Button>
              <Button
                variant="outline"
              ...
              >
                <CodexWebIcon name="web_simple" size="md" aria-hidden />
                {t('skills.global')}
              </Button>
            </div>
            <p className="text-xs text-muted-foreground">
              {scope === "project"
                ? `Saved in .agents/skills/${skillNamePreview} (this project only)`
                : `Saved in ~/.agents/skills/${skillNamePreview} (available everywhere)`}
            </p>
          </div>
