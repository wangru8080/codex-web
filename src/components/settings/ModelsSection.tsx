    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1">
          <CodexWebIcon name="search" size="sm" className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none" aria-hidden />
          <Input
            id="models-search"
            name="models-search"
            value={search}
      ...
      {/* Phase 5 Phase 6 IA correction (2026-05-14) — Codex Account is a
          ...
          from CodexWeb's DB. The block surfaces them in Models so users
        ...
        >
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between gap-2">
              ...
              >
                <CodexWebIcon name="plus" size={12} strokeWidth={2} aria-hidden />
                {isZh ? '添加模型' : 'Add model'}
              </Button>
              </div>
            </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isCurrentDefault(provider.id, model.model_id) && (
                          ...
                          >
                            <CodexWebIcon name="pin" size={9} strokeWidth={2} aria-hidden />
                            {isZh ? '默认' : 'Default'}
                          </span>
                        )}
          ...
          {(() => {
            ...
            return (
              <div className="mt-2 -mb-1 text-[11px] text-muted-foreground">
                ...
                >
                  {isZh ? '让 CodexWeb 重新检测一次该服务商的模型列表' : 'Re-detect this provider\'s upstream models'}
                </button>
              </div>
            );
          })()}
