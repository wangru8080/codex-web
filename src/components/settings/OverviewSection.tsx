  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <OverviewCard
          icon={<CodexWebIcon name="runtime" size="md" strokeWidth={runtimeIsFallback ? undefined : 2} />}
        ...
        <OverviewCard
          ...
          // CodexWebIcon `health` glyph (HugeIcons HeartCheck —
          // stroked). The other Overview cards already use stroked
          // CodexWebIcon glyphs (runtime / model / provider); the
          ...
          icon={<CodexWebIcon name="health" size="md" />}
