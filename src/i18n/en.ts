...
const en = {
  ...
  'chatList.pinProject': 'Pin Project',
  'chatList.unpinProject': 'Unpin Project',
  'chatList.pinConversation': 'Pin Conversation',
  'chatList.unpinConversation': 'Unpin Conversation',
  'chatList.expandPinned': 'Expand pinned items',
  'chatList.collapsePinned': 'Collapse pinned items',
  ...
  'serverRequest.otherPrompt': 'Other, and tell Codex what to do instead',
  'serverRequest.skip': 'Skip',
  ...
  'settings.configPageDescription': 'Configure approval policies and sandbox settings',
  'settings.configLearnMore': 'Learn more',
  'settings.configDescription': 'Edit your configuration to customize agent behavior',
  'settings.configRefreshDescription': 'Refresh the page after editing to apply changes',
  ...
  'settings.configSave': 'Save',
  'settings.configLoading': 'Loading config.toml…',
  'settings.configReadError': 'Unable to read config.toml',
  'settings.configWriteError': 'Unable to save config.toml',
  'settings.hooks': 'Hooks',
  'settings.hooksDescription': 'Manage lifecycle hooks from configuration and enabled plugins.',
  'settings.hooksLearnMore': 'Learn more',
  'settings.hooksReload': 'Reload hooks',
  'settings.hooksEmptyTitle': 'No hooks found',
  'settings.hooksEmptyDescription': 'Configured hooks will appear here',
  'settings.hooksFromConfig': 'From configuration',
  'settings.hooksUserConfig': 'User configuration',
  'settings.hooksProjectConfig': 'Project configuration',
  'settings.hooksPluginConfig': 'Plugins',
  'settings.hooksManagedConfig': 'Managed configuration',
  'settings.hooksCount': '{count} hooks',
  'settings.hooksPendingReview': '{count} pending review',
  'settings.hooksAllProjects': 'All projects',
  'settings.hooksSecurityWarning': 'Hooks can run outside the sandbox. Review all recently installed or modified hooks.',
  'settings.hooksTrust': 'Trust',
  'settings.hooksTrustAll': 'Trust all',
  'settings.hooksReview': 'Review hooks',
  'settings.hooksOpenConfig': 'Open configuration file',
  'settings.hooksHandler': 'Hook {count}',
  'settings.hooksProcessor': 'Handler',
  'settings.hooksCommand': 'Command',
  'settings.hooksMatcher': 'Matcher',
  'settings.hooksTimeout': 'Timeout',
  'settings.hooksSeconds': '{count}s',
  'settings.hooksStatusMessage': 'Status message',
  'settings.hooksSave': 'Save',
  'settings.hooksCancel': 'Cancel',
  'settings.hooksLoading': 'Loading hooks…',
  'settings.hooksLoadError': 'Unable to load hooks',
  'settings.hooksSaveError': 'Unable to save hook configuration',
  'settings.hooksConfigInvalid': 'The hook configuration is invalid. Fix it and save again.',
  'settings.hooksNoCommand': 'This handler has no executable command',
  'settings.hooksManaged': 'Managed by your administrator',
  'settings.hooksModified': 'Configuration changed and must be reviewed again',
  'settings.hooksUntrusted': 'Hook remains disabled until it is trusted',
  'settings.hooksEvent.preToolUse': 'Before a tool executes',
  'settings.hooksEvent.permissionRequest': 'When permission is requested',
  'settings.hooksEvent.postToolUse': 'After a tool executes',
  'settings.hooksEvent.preCompact': 'Before context compaction',
  'settings.hooksEvent.postCompact': 'After context compaction',
  'settings.hooksEvent.sessionStart': 'When a new session starts',
  'settings.hooksEvent.userPromptSubmit': 'When the user submits a prompt',
  'settings.hooksEvent.subagentStart': 'When a subagent starts',
  'settings.hooksEvent.subagentStop': 'When a subagent stops',
  'settings.hooksEvent.stop': 'Before Codex finishes this response',
  ...
  'filePreview.documentParseFailed': 'Could not parse this document',
  'filePreview.legacyDocNotice': 'Legacy DOC preview is experimental; complex formatting may differ from Word.',
  'filePreview.emptySpreadsheet': 'This worksheet is empty',
  'filePreview.spreadsheetTruncated': 'Preview limited to {rows} rows and {columns} columns',
  ...
  'skills.installScope': 'Install scope',
  'skills.installScope.global': 'Global',
  'skills.installScope.project': 'Current project',
  ...
  'workspaceSidebar.sideChat.description': 'Side chats are temporary and disappear when you close the app.',
  'workspaceSidebar.sideChat.creating': 'Creating side chat',
  'workspaceSidebar.sideChat.unavailable': 'Side chat is currently unavailable.',
  'workspaceSidebar.sideChat.retry': 'Retry',
  'workspaceSidebar.sideChat.closeTitle': 'Close side chat?',
  'workspaceSidebar.sideChat.closeDescription': 'This side chat will be deleted and cannot be recovered. Are you sure?',
  'workspaceSidebar.sideChat.doNotAskAgain': "Don't ask again",
  'workspaceSidebar.sideChat.cancel': 'Cancel',
  'workspaceSidebar.sideChat.closeAction': 'Close side chat',
  'workspaceSidebar.terminal.connecting': 'Connecting terminal…',
  'workspaceSidebar.terminal.noDirectory': 'Select a working directory first',
  'workspaceSidebar.terminal.exited': 'Terminal process exited (code {code})',
  ...
  'security.turnstileTestFailed': 'Unable to complete the Turnstile configuration check.',
  'security.turnstileTestFailedCode': 'Unable to complete the Turnstile configuration check. Error code: {code}',
  'security.turnstileTestPassed': 'Browser verification passed. You can save now.',
  'security.save': 'Save',
