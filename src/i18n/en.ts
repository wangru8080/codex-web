...
const en = {
  ...
  'settings.aboutDesc': 'CodexWeb version, platform info, account, diagnostics & maintenance, documentation & feedback',
  ...
  'provider.emptyDesc': 'Add your first AI service. CodexWeb will surface its supported models and capabilities automatically.',
  ...
  'mcp.builtin.sectionDescription': 'CodexWeb includes these MCP capabilities. They are injected only when relevant to the current message; this list does not mean every message has them enabled.',
