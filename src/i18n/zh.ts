...
const zh: Record<TranslationKey, string> = {
  ...
  'settings.general': '通用',
  'settings.about': '关于',
  'settings.aboutDesc': 'CodexWeb 版本、平台信息、账户、诊断 / 维护、文档与反馈',
  ...
  'provider.emptyDesc': '添加你的第一个 AI 服务，CodexWeb 会自动展示它支持的模型与能力。',
  ...
  'mcp.builtin.sectionDescription': 'CodexWeb 自带这些 MCP 能力。是否注入取决于本次消息；这里展示并不代表当前消息已经全部启用。',
