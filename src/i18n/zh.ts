...
const zh: Record<TranslationKey, string> = {
  ...
  'chatList.archiveConfirm': '确定归档此对话吗？',
  'chatList.archiveProjectConfirm': '确定归档项目“{project}”中的所有对话吗？',
  ...
  'chatList.pinned': '置顶',
  'chatList.pinProject': '置顶项目',
  'chatList.unpinProject': '取消置顶项目',
  'chatList.pinConversation': '置顶聊天',
  'chatList.unpinConversation': '取消置顶聊天',
  'chatList.expandPinned': '展开置顶内容',
  'chatList.collapsePinned': '收起置顶内容',
  ...
  'messageList.emptyDescription': '开始与 CodexWeb 对话。提问、获取代码帮助或探索想法。',
  ...
  'chat.plan.proposedTitle': '建议计划',
  'chat.plan.updatedTitle': '计划更新',
  'chat.plan.noSteps': '暂未提供计划步骤',
  'chat.plan.implementationTitle': '是否执行此计划？',
  'chat.plan.implement': '执行此计划',
  'chat.plan.clearContextImplement': '清空上下文并执行',
  'chat.plan.stay': '暂不执行，继续规划',
  ...
  'streaming.reconnecting': '正在重新连接 {current}/{total}',
  'streaming.expandRetryDetails': '展开重试详情',
  'streaming.collapseRetryDetails': '收起重试详情',
  'streaming.allowForSession': '本次会话允许',
  'streaming.allowed': '已允许',
  'streaming.denied': '已拒绝',
  'streaming.permissionTimedOut': '已超时自动拒绝',
  'serverRequest.title': '需要用户输入',
  'serverRequest.userInput.title': 'Codex 需要你的输入',
  'serverRequest.userInput.autoResolutionCountdown': '{remaining} 后自动处理',
  'serverRequest.mcp.title': '{server} 正在请求输入',
  'serverRequest.mcp.openLink': '打开链接',
  'serverRequest.mcp.unsupportedForm': '此 MCP 表单使用了 Codex Web 无法安全呈现的 schema。请拒绝或取消请求后继续。',
  'serverRequest.answerPlaceholder': '输入回答',
  'serverRequest.otherPrompt': '其他，请告诉 Codex 应该如何处理',
  'serverRequest.skip': '跳过',
  'serverRequest.submit': '提交',
  'serverRequest.submitting': '提交中...',
  'serverRequest.decline': '拒绝',
  'serverRequest.continue': '继续',
  ...
  // ── Settings: General ───────────────────────────────────────
  'settings.title': '设置',
  'settings.description': '管理 CodexWeb 和 Claude Code 设置',
  ...
  'settings.configPageDescription': '配置审批策略和沙盒设置',
  'settings.configLearnMore': '了解更多',
  'settings.configDescription': '编辑你的配置以自定义代理行为',
  'settings.configRefreshDescription': '编辑后请刷新页面以应用更改',
  'settings.configDocs': '文档',
  'settings.configFile': 'config.toml',
  'settings.configOpen': '打开 config.toml',
  'settings.configCancel': '取消',
  'settings.configSave': '保存',
  'settings.configLoading': '正在加载 config.toml…',
  'settings.configReadError': '无法读取 config.toml',
  'settings.configWriteError': '无法保存 config.toml',
  'settings.hooks': '钩子',
  'settings.hooksDescription': '通过配置和已启用的插件管理生命周期钩子。',
  'settings.hooksLearnMore': '了解更多',
  'settings.hooksReload': '重新加载钩子',
  'settings.hooksEmptyTitle': '未找到钩子',
  'settings.hooksEmptyDescription': '已配置的钩子将显示在此处',
  'settings.hooksFromConfig': '来自配置',
  'settings.hooksUserConfig': '用户配置',
  'settings.hooksProjectConfig': '项目配置',
  'settings.hooksPluginConfig': '插件',
  'settings.hooksManagedConfig': '托管配置',
  'settings.hooksCount': '{count} 个钩子',
  'settings.hooksPendingReview': '{count} 项待审核',
  'settings.hooksAllProjects': '所有项目',
  'settings.hooksSecurityWarning': '钩子可在沙盒外运行，因此，请审查最近安装或修改的所有钩子',
  'settings.hooksTrust': '信任',
  'settings.hooksTrustAll': '全部信任',
  'settings.hooksReview': '审查钩子',
  'settings.hooksOpenConfig': '打开配置文件',
  'settings.hooksHandler': '钩子 {count}',
  'settings.hooksProcessor': '处理程序',
  'settings.hooksCommand': '命令',
  'settings.hooksMatcher': '匹配器',
  'settings.hooksTimeout': '超时',
  'settings.hooksSeconds': '{count}秒',
  'settings.hooksStatusMessage': '状态消息',
  'settings.hooksSave': '保存',
  'settings.hooksCancel': '取消',
  'settings.hooksLoading': '正在加载钩子…',
  'settings.hooksLoadError': '无法加载钩子',
  'settings.hooksSaveError': '无法保存钩子配置',
  'settings.hooksConfigInvalid': '钩子配置不正确，请修正后再次保存。',
  'settings.hooksNoCommand': '当前处理程序没有可执行命令',
  'settings.hooksManaged': '由管理员管理',
  'settings.hooksModified': '配置已修改，需要重新审查',
  'settings.hooksUntrusted': '钩子在标记为可信之前保持禁用',
  'settings.hooksEvent.preToolUse': '工具执行前',
  'settings.hooksEvent.permissionRequest': '当请求权限时',
  'settings.hooksEvent.postToolUse': '工具执行后',
  'settings.hooksEvent.preCompact': '压缩上下文前',
  'settings.hooksEvent.postCompact': '压缩上下文后',
  'settings.hooksEvent.sessionStart': '当新会话开始时',
  'settings.hooksEvent.userPromptSubmit': '当用户提交提示时',
  'settings.hooksEvent.subagentStart': '当子代理开始时',
  'settings.hooksEvent.subagentStop': '当子代理停止时',
  'settings.hooksEvent.stop': '在 Codex 结束本轮响应之前',
  'settings.about': '关于',
  'settings.aboutDesc': 'CodexWeb 版本、平台信息',
  ...
  'about.update.current': '当前已是最新版本。',
  'about.update.failed': '暂时无法检查更新，请稍后重试。',
  'about.update.viewRelease': '前往 npm 查看',
  'about.update.copyCommand': '复制升级命令',
  'settings.cancel': '取消',
  ...
  'settings.appearanceDesc': '自定义 CodexWeb 的外观和风格',
  ...
  'cli.agentRuntimeDesc': '选择 CodexWeb 执行 Agent 任务的方式',
  'cli.runtimeNative': 'CodexWeb 引擎 (AI SDK)',
  ...
  'filePreview.documentParseFailed': '无法解析该文档',
  'filePreview.legacyDocNotice': '旧版 DOC 为实验性预览，复杂排版可能与 Word 不一致。',
  'filePreview.emptySpreadsheet': '该工作表为空',
  'filePreview.spreadsheetTruncated': '预览限制为 {rows} 行、{columns} 列',
  ...
  'filePreview.external.confirm.body': '确认打开后将以只读模式预览。文件不会自动加载，确认前 CodexWeb 不会读取磁盘内容。',
  ...
  'skills.uninstall': '卸载',
  'skills.uninstallConfirm': '再次点击以确认卸载',
  'skills.tryNow': '立即试用',
  'skills.enable': '启用',
  'skills.disable': '禁用',
  'skills.createMissingRoot': '创建项目技能前请先选择项目目录',
  'skills.installs': '次安装',
  'skills.source': '来源',
  'skills.installedAt': '安装时间',
  'skills.installSuccess': '安装完成',
  'skills.installFailed': '安装失败',
  'skills.installScope': '安装范围',
  'skills.installScope.global': '全局',
  'skills.installScope.project': '当前项目',
  ...
  'mcp.noServersDesc': '添加 MCP 服务器以扩展 Codex的能力',
  'mcp.arguments': '参数：',
  ...
  'connection.gitInstallSuccess': 'Git 安装成功！请重启 CodexWeb。',
  ...
  'connection.upgradeSuccess': '升级成功！请重启 CodexWeb 以应用更新。',
  ...
  'feishu.quickCreateDesc': '自动创建飞书机器人并绑定到 CodexWeb，无需手动配置权限和事件',
  ...
  'settings.tasks': '定时任务',
  'settings.archivedGroup': '已归档',
  'settings.archivedTasks': '已归档任务',
  'archived.title': '已归档任务',
  'archived.searchPlaceholder': '搜索已归档任务',
  'archived.allTasks': '所有任务',
  'archived.namedTasks': '已命名任务',
  'archived.unnamedTasks': '未命名任务',
  'archived.allProjects': '所有项目',
  'archived.taskCount': '{count} 个任务',
  'archived.unarchive': '取消归档',
  'archived.deleteAll': '全部删除',
  'archived.deleteProject': '删除项目中的全部已归档任务',
  'archived.deleteOneTitle': '永久删除此已归档任务？',
  'archived.deleteProjectTitle': '永久删除此项目中的全部已归档任务？',
  'archived.deleteAllTitle': '永久删除全部已归档任务？',
  'archived.deleteWarning': '此操作无法撤销，会永久删除对应的会话历史。',
  'archived.empty': '暂无已归档任务',
  'archived.noResults': '没有符合当前筛选条件的已归档任务',
  'archived.loadFailed': '加载已归档任务失败',
  'archived.actionFailed': '操作失败，请重试。',
  'archived.untitled': '未命名任务',
  ...
  'mcp.authStatus': '认证',
  'mcp.resources': '资源',
  'mcp.resourceTemplates': '资源模板',
  'mcp.enabled': '已启用',
  'mcp.disabled': '已禁用',
  'mcp.managerDesc': '开关控制 CodexWeb 注入的 MCP 服务。Claude Code 自身配置中的服务仍可能被 SDK 通过 settingSources 自动加载。',
  ...
  'cliTools.viewDocs': '查看 CodexWeb 官方文档',
  ...
  'chat.newChat.welcome.project.1': '我们应该在 {project} 中做些什么？',
  ...
  'error.providerUnavailable': 'Codex 账户不可用',
  ...
  // run checkpoint
  'runCheckpoint.noProvider.title': 'Codex 账户不可用',
  'runCheckpoint.noProvider.description': '发送前需要登录 Codex 或配置 API Key。',
  'runCheckpoint.noProvider.action': '打开 Codex 设置',
  ...
  'workspaceSidebar.sideChat.description': '侧边聊天是临时聊天，关闭应用后会消失。',
  'workspaceSidebar.sideChat.creating': '正在创建侧边聊天',
  'workspaceSidebar.sideChat.unavailable': '当前无法创建侧边聊天。',
  'workspaceSidebar.sideChat.retry': '重试',
  'workspaceSidebar.sideChat.closeTitle': '关闭侧边聊天？',
  'workspaceSidebar.sideChat.closeDescription': '这个侧边聊天将被删除，且无法恢复。你确定吗？',
  'workspaceSidebar.sideChat.doNotAskAgain': '不再询问',
  'workspaceSidebar.sideChat.cancel': '取消',
  'workspaceSidebar.sideChat.closeAction': '关闭侧边聊天',
  'workspaceSidebar.terminal.connecting': '正在连接终端…',
  'workspaceSidebar.terminal.noDirectory': '请先选择工作目录',
  'workspaceSidebar.terminal.exited': '终端进程已退出（代码 {code}）',
  ...
  'security.sessionTitle': 'Web 登录会话',
  'security.loading': '正在加载账户...',
  'security.logout': '退出登录',
  'security.logoutFailed': '退出登录失败',
  'security.turnstileDescription': '登录页面的机器人防护',
  'security.enable': '启用 Turnstile',
  'security.enableDescription': '登录前需要完成 Cloudflare Turnstile 验证',
  'security.siteKey': '站点密钥',
  'security.secretKey': '私密密钥',
  'security.cloudflareDashboard': '打开 Cloudflare Dashboard',
  'security.secretConfiguredPlaceholder': '已配置，留空保留当前值',
  'security.secretConfiguredHint': '私密密钥已配置，留空将保留当前值。',
  'security.secretHint': '私密密钥仅保存在服务端。',
  'security.turnstileTestFailed': '无法完成 Turnstile 配置预检。',
  'security.turnstileTestFailedCode': '无法完成 Turnstile 配置预检。错误代码：{code}',
  'security.turnstileTestPassed': '浏览器验证已通过，可以保存。',
  'security.save': '保存',
  'security.saving': '正在保存...',
  'security.saved': '安全设置已保存',
  'security.loadFailed': '无法加载安全设置',
  'security.saveFailed': '无法保存安全设置',
};
